...
def get_log_data():
    ...
    request = LogAPI(dataverse_client)

    requests: list[LogModel] = request.get_codes_log()
...
#     request_api = LogAPI(get_dataverse_client())
#     return request_api.update_request_status_remark_API(request_id, status, remark)
